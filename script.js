...
function isAlphabet(str){
    ...
    if(char.some(c => c.charCodeAt() < 65 && c.charCodeAt() != 32 && c.charCodeAt() !=39 && c.charCodeAt() !=47 )){
        return false
    } else if(char.some(c => c.charCodeAt() > 90 && c.charCodeAt() < 97 && c.charCodeAt() > 122)){
        return false
    } 
    return true
}
...
function isNumber(str){
    ...
    if(char.some(c=> c.charCodeAt() < 48 || c.charCodeAt() > 57  )) return false
    return true
}
